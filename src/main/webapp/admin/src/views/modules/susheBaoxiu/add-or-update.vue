    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="xueshengId" name="xueshengId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修编号" prop="susheBaoxiuUuidNumber">
                       <el-input v-model="ruleForm.susheBaoxiuUuidNumber"
                                 placeholder="报修编号" clearable  :readonly="ro.susheBaoxiuUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修编号" prop="susheBaoxiuUuidNumber">
                           <el-input v-model="ruleForm.susheBaoxiuUuidNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修名称" prop="susheBaoxiuName">
                       <el-input v-model="ruleForm.susheBaoxiuName"
                                 placeholder="报修名称" clearable  :readonly="ro.susheBaoxiuName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修名称" prop="susheBaoxiuName">
                           <el-input v-model="ruleForm.susheBaoxiuName"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="报修物品" prop="susheBaoxiuWupinName">
                       <el-input v-model="ruleForm.susheBaoxiuWupinName"
                                 placeholder="报修物品" clearable  :readonly="ro.susheBaoxiuWupinName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="报修物品" prop="susheBaoxiuWupinName">
                           <el-input v-model="ruleForm.susheBaoxiuWupinName"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="报修详情" prop="susheBaoxiuContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.susheBaoxiuContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.susheBaoxiuContent" label="报修详情" prop="susheBaoxiuContent">
                            <span v-html="ruleForm.susheBaoxiuContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12" v-if="!(type!='info' && sessionTable =='xuesheng')">
                    <el-form-item class="select" v-if="type!='info'"  label="报修状态" prop="susheBaoxiuTypes">
                        <el-select v-model="ruleForm.susheBaoxiuTypes" :disabled="ro.susheBaoxiuTypes" placeholder="请选择报修状态">
                            <el-option
                                v-for="(item,index) in susheBaoxiuTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="报修状态" prop="susheBaoxiuValue">
                        <el-input v-model="ruleForm.susheBaoxiuValue"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    susheId: false,
                    xueshengId: false,
                    susheBaoxiuUuidNumber: false,
                    susheBaoxiuName: false,
                    susheBaoxiuWupinName: false,
                    susheBaoxiuContent: false,
                    insertTime: false,
                    susheBaoxiuTypes: false,
                },
                ruleForm: {
                    susheId: '',
                    xueshengId: '',
                    susheBaoxiuUuidNumber: new Date().getTime(),
                    susheBaoxiuName: '',
                    susheBaoxiuWupinName: '',
                    susheBaoxiuContent: '',
                    insertTime: '',
                    susheBaoxiuTypes: '',
                },
                susheBaoxiuTypesOptions : [],
                susheOptions : [],
                xueshengOptions : [],
                rules: {
                   susheId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=sushe_baoxiu_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.susheBaoxiuTypesOptions = data.data.list;
                    }
                });
